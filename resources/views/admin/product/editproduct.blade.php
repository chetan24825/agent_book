                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="Product" name="product"
                                                value="{{ old('product', $product->product_name) }}" required />
                                            @error('product')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group" data-toggle="aizuploader" data-type="image"
                                                ...
                                                <input type="hidden" name="thumbphotos" class="selected-files"
                                                    value="{{ old('thumbphotos', $product->thumbphotos) }}" required>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group" data-toggle="aizuploader" data-type="image"
                                                ...
                                                <input type="hidden" name="multiple_image" class="selected-files"
                                                    value="{{ old('multiple_image', $product->multiple_image) }}">
                                            </div>
                                            <div class="file-preview box sm"></div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-md-12">
                                            <label for="short_description" class="form-label mt-3">Short Description <span
                                                    class="text-danger">*</span> </label>
                                            <textarea class="form-control" id="" name="short_description" rows="3" required>{{ old('short_description', $product->short_description) }}</textarea>
                                        ...
                                        <div class="col-md-12">
                                            <label for="terms_conditions" class="form-label mt-3">Terms &
                                                Conditions</label>
                                            <textarea class="form-control" name="terms_conditions" rows="3">{{ old('terms_conditions', $product->terms_conditions) }}</textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-select form-control" id="in_stock" name="in_stock"
                                                    required>
                                                    <option value="1"
                                                        {{ old('in_stock', $product->in_stock) == 1 ? 'selected' : '' }}>
                                                        Available </option>
                                                    <option value="0"
                                                        {{ old('in_stock', $product->in_stock) == 0 ? 'selected' : '' }}>
                                                        Out Of Stock</option>
                                                </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" class="form-control" id="MRPPrice"
                                                    name="mrp_price" step="0.01"
                                                    value="{{ old('mrp_price', $product->mrp_price) }}" required />
                                                @error('mrp_price')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" class="form-control" id="purchase_gst"
                                                    ...
                                                    value="{{ old('purchase_gst', $product->purchase_gst) }}" />
                                                @error('purchase_gst')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" class="form-control" id="netcost"
                                                    name="net_cost" step="0.01"
                                                    value="{{ old('net_cost', $product->net_cost) }}" required />
                                                @error('net_cost')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" class="form-control" id="sale_gst"
                                                    name="sale_gst" step="0.01"
                                                    value="{{ old('sale_gst', $product->sale_gst) }}" required />
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" class="form-control" readonly id="payable_gst"
                                                    ...
                                                    value="{{ old('payable_gst', $product->payable_gst) }}" />
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="meta_keywords" class="form-control" id="meta_keywords" cols="4" rows="4">{{ old('meta_keywords', $product->meta_keywords) }}</textarea>
                                                @error('meta_keywords')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <label for="meta_description" class="form-label mt-3">Meta
                                                    Description</label>
                                                <textarea name="meta_description" class="form-control" id="meta_description" cols="4" rows="4">{{ old('meta_description', $product->meta_description) }}</textarea>
...
@push('styles')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Function to calculate Purchase GST and Net Cost
            ...
            // Function to calculate Sale Price, GST, and Distribution
            function calculateSalePrice() {
                ...
                // Calculate and display the "Distribute" value
            ...
            $('#purchase_gst, #purchase').on('keyup', calculatePurchaseGST);
            $('#saleprice, #disper, #sale_gst').on('keyup', calculateSalePrice);

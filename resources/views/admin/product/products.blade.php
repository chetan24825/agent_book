                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="datatable-products" class="table table-bordered table-striped nowrap"
                                            style="width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                            ...
                                            <tbody>
                                                @foreach ($products as $product)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($product->subcategory?->category_name)
                                                                <span class="badge bg-info">
                                                                    {{ $product->subcategory->category_name ?? 'No Sub Category' }}
                                                                </span>
                                                            @endif
                                                        </td>
                                                        ...
                                                        <td>
                                                            <span
                                                                class="badge {{ $product->status ? 'bg-success' : 'bg-danger' }}">
